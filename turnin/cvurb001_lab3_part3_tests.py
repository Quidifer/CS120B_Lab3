...
tests = [ 
    {'description': 'PINA: 1 => PINC: 0x60',
    'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 5 } ],
    'expected': [('PORTC',0x60)],
    },

    {'description': 'PINA: 2 => PINC: 0x60',
    'steps': [ {'inputs': [('PINA',0x02)], 'iterations': 5 } ],
    'expected': [('PORTC',0x60)],
    },

    {'description': 'PINA: 3 => PINC: 0x70',
    ...
    {'description': 'PINA: 5 => PINC: 0x38',
    'steps': [ {'inputs': [('PINA',0x05)], 'iterations': 5 } ],
    'expected': [('PORTC',0x38)],
    },

    {'description': 'PINA: 6 => PINC: 0x38',
    'steps': [ {'inputs': [('PINA',0x06)], 'iterations': 5 } ],
    'expected': [('PORTC',0x38)],
    },

    {'description': 'PINA: 7 => PINC: 0x3C',
    'steps': [ {'inputs': [('PINA',0x07)], 'iterations': 5 } ],
    'expected': [('PORTC',0x3C)],
    },

    {'description': 'PINA: 8 => PINC: 0x3C',
    'steps': [ {'inputs': [('PINA',0x08)], 'iterations': 5 } ],
    'expected': [('PORTC',0x3C)],
    },

    {'description': 'PINA: 9 => PINC: 0x3C',
    ...
    {'description': 'PINA: 13 => PINC: 0x3F',
    'steps': [ {'inputs': [('PINA',0x0D)], 'iterations': 5 } ],
    'expected': [('PORTC',0x3F)],
    },
#-----------------------------
    {'description': 'PINA: 0x70 => PINC: 0xc0',
    'steps': [ {'inputs': [('PINA',0x30)], 'iterations': 5 } ],
    'expected': [('PORTC',0xc0)],
    },

    {'description': 'PINA: 0x60 => PINC: 0x40',
